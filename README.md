...
<p align="center">  
If you like the idea click ⭐ on the repo and <a href="https://twitter.com/intent/tweet?text=Nice%20xontrib%20for%20the%20xonsh%20shell!&url=https://github.com/AsafFisher/xontrib-oh-my-xonsh" target="_blank">tweet</a>.
</p>
...
```bash
xpip install xontrib-oh-my-xonsh
# or: xpip install -U git+https://github.com/AsafFisher/xontrib-oh-my-xonsh
```

## Usage

```bash
xontrib load oh_my_xonsh
# TODO: what's next?
```
